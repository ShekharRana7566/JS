let jokes=[`I went to a street where the houses were numbered 8k, 16k, 32k, 64k, 128k, 256k and 512k.
...
let numb=Math.floor(Math.random()*(jokes.length-1))

console.log(jokes[numb])